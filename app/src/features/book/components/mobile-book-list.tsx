    ...
    <div className="w-full grid grid-cols-2 gap-4 md:hidden mb-8">
      {books.map((book) => (
        <div key={book.id} className="group" data-testid="book-card">
          <Link href={`/book/${book.slug}`} className="space-y-4">
            <div
            ...
            >
              {book.cover ? (
                ...
                <div className="w-full h-64 md:h-96 xl:h-72 bg-gray-300 dark:bg-gray-400 rounded-lg flex flex-row-reverse justify-between p-3 md:p-4 select-none">
