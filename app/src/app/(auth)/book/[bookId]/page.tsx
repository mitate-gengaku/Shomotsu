...
import { bookData } from "@/config/book-data";
          ...
          <div className="w-full mb-6 space-y-4">
            <div className="hidden md:block">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2 flex-wrap">
                ...
                >
                  <CpuIcon className="text-teal-500" />
                  テクノロジー
                </Button>
                <Button
                  size={"sm"}
                  ...
                  className="rounded-full transition-all"
                >
                  <ComputerIcon className="text-teal-500" />
                  コンピューター
                </Button>
              </div>
            </div>
            <div className="hidden md:block">
              ...
              <p className="text-gray-500 text-sm">{bookData.createdAt}</p>
            </div>
